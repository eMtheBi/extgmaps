 ...
 *
 */
class Themes extends BasicTreeModel {
	 ...
	 *
	 * @param Categories $categoryToRemove The Categories to be removed
	 * @return void
	 */
	public function removeCategories(Categories $categoryToRemove) {
