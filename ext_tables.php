...
$addToTca = Array(
	...
	'map' => Array(
		...
		'config' => Array(
			'type' => 'user',
			'userFunc' => 'EXT:extgmaps/Classes/Services/TceMap.php:&TceMap->displayMap'
		)
	),
...
$addToPages = array(
	'image' => array(
		'exclude' => 0,
		'label' => 'LLL:EXT:extgmaps/Resources/Private/Language/locallang_db.xlf:tx_extgmaps_domain_model_tags.image',
		'config' => array(
			'maxitems' => 1,
			'type' => 'inline',
